...
class LineEmissivity:
    ...
    def write(self, atomic_number, electron_number, temperatures, densities):
        ...
        input_dir      = "../database02/{0:s}/{0:s}{1:02d}_spec".format(pfac.fac.ATOMICSYMBOL[atomic_number], electron_number)
        output_dir     = "../database02/{0:s}/{0:s}{1:02d}_line".format(pfac.fac.ATOMICSYMBOL[atomic_number], electron_number)
